...
const (
	...
	AuthService_GetOwnUserData_FullMethodName = "/auth.AuthService/GetOwnUserData"
...
type AuthServiceClient interface {
	...
	GetOwnUserData(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*User, error)
	// Admin methods
...
func (c *authServiceClient) GetOwnUserData(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*User, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(User)
	err := c.cc.Invoke(ctx, AuthService_GetOwnUserData_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthServiceServer interface {
	...
	GetOwnUserData(context.Context, *emptypb.Empty) (*User, error)
	// Admin methods
...
func (UnimplementedAuthServiceServer) GetOwnUserData(context.Context, *emptypb.Empty) (*User, error) {
...
func _AuthService_GetOwnUserData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(emptypb.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServiceServer).GetOwnUserData(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthService_GetOwnUserData_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).GetOwnUserData(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _AuthService_GetOwnUserData_Handler,
		},
		{
			MethodName: "GetUser",
